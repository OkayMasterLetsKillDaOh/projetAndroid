...
/**
 * Created by MOMO Adrien Nickson on 08/03/21.
 */
public class ArdoiseView extends View {
    ...
    ArdoiseView(Context context) {
        this(context, null);
    }

    public ArdoiseView(Context context, AttributeSet attributeSet) {
        super(context);

        mBackgroundColor = Color.parseColor("#FFFF5500");
        mDrawColor = Color.parseColor("#FFFFEB3B");
